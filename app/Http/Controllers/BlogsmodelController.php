...
class BlogsmodelController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'blogsmodel';
	static $per_page	= '50';
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('blogsmodel');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('blogsmodel.public.view',$data);			
			}			
		} 
		else {
			...
			return view('blogsmodel.public.index',$data);	
		}
