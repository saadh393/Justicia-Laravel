...
class PagescontrollerController extends Controller {
	...
	public $module = 'pagescontroller';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Pagescontroller();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'pagescontroller',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('pagescontroller');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('pagescontroller.public.view',$data);			
			}			
		} 
		else {
			...
			return view('pagescontroller.public.index',$data);	
		}
