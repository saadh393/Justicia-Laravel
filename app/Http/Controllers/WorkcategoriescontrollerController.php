...
use App\Models\Workcategoriescontroller;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class WorkcategoriescontrollerController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'workcategoriescontroller';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Workcategoriescontroller();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'workcategoriescontroller',
	...
	public static function display(  )
	{
		...
		$model  = new Workcategoriescontroller();
		$info = $model::makeInfo('workcategoriescontroller');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('workcategoriescontroller.public.view',$data);			
			}			
		} 
		else {
			...
			return view('workcategoriescontroller.public.index',$data);	
		}
