...
use App\Models\Backendpublication;
...
class BackendpublicationController extends Controller {
	...
	public $module = 'backendpublication';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Backendpublication();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'backendpublication',
	...
	public static function display(  )
	{
		...
		$model  = new Backendpublication();
		$info = $model::makeInfo('backendpublication');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('backendpublication.public.view',$data);			
			}			
		} 
		else {
			...
			return view('backendpublication.public.index',$data);	
		}
