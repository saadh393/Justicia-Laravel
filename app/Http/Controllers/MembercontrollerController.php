...
use App\Models\Membercontroller;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class MembercontrollerController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'membercontroller';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Membercontroller();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'membercontroller',
	...
	public static function display(  )
	{
		...
		$model  = new Membercontroller();
		$info = $model::makeInfo('membercontroller');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('membercontroller.public.view',$data);			
			}			
		} 
		else {
			...
			return view('membercontroller.public.index',$data);	
		}
