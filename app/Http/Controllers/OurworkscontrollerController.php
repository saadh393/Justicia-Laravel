...
use App\Models\Ourworkscontroller;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class OurworkscontrollerController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ourworkscontroller';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourworkscontroller();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourworkscontroller',
	...
	public static function display(  )
	{
		...
		$model  = new Ourworkscontroller();
		$info = $model::makeInfo('ourworkscontroller');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourworkscontroller.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourworkscontroller.public.index',$data);	
		}
