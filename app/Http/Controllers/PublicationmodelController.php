...
class PublicationmodelController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'publicationmodel';
	static $per_page	= '50';
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('publicationmodel');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('publicationmodel.public.view',$data);			
			}			
		} 
		else {
			...
			return view('publicationmodel.public.index',$data);	
		}
