...
use App\Models\Backendourworks;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class BackendourworksController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'backendourworks';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Backendourworks();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'backendourworks',
	...
	public static function display(  )
	{
		...
		$model  = new Backendourworks();
		$info = $model::makeInfo('backendourworks');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('backendourworks.public.view',$data);			
			}			
		} 
		else {
			...
			return view('backendourworks.public.index',$data);	
		}
