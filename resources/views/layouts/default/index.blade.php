...
<head>
    ...
    <link href="{{ secure_asset('frontend/default/css/style.css') }}" rel="stylesheet">
...
<body id="body">
                    ...
                    <a href="{{ url('') }}">
                        ...
                        @if (file_exists(public_path() . '/uploads/images/' . config('sximo')['cnf_logo']) && config('sximo')['cnf_logo'] != '')
                            <img src="{{ secure_asset('uploads/images/' . config('sximo')['cnf_logo']) }}"
                                alt="{{ config('sximo')['cnf_appname'] }}" width="30" />
                        @else
  ...
  ============================-->
    ...
    <script type="text/javascript" src="{{ secure_asset('frontend/default/js/default.min.js') }}"></script>
