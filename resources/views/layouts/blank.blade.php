...
<head>
    ...
    @if (session('themes') != '')
        <link href="{{ secure_asset('') }}assets/template/css/colors/{{ session('themes') }}.css" id="theme"
            rel="stylesheet">
    @else
        <link href="{{ secure_asset('') }}assets/template/css/colors/gray.css" id="theme" rel="stylesheet">
    @endif
    <!-- jQuery UI 1.11.4 -->
