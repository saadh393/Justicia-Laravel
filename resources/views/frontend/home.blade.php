...
<section class="py-28 mt-10 md:mt-28">
    <div class="wrapper space-y-6 " id="about">
        <h1 class="font-bold text-3xl text-primary-pink text-center"> {{ $metaData['about-us']['title'] }} </h1>
        <p class="paragraph text-center">
            {{ $metaData['about-us']['description'] }}
        </p>
    </div>
</section>
    ...
    <div class="wrapper space-y-20">
        ...
        <div class="vision grid md:grid-cols-2 items-center relative">
            <div class="bg-dots wow fadeIn">
                <img
                    class="h-[375px] object-contain relative z-10 drop-shadow-[0_35px_35px_rgba(255, 209, 227,0.25)]"
                    src="./uploads/meta/{{ $metaData['our-vision']['meta_image'] }}"
                    alt="{{ $metaData['our-vision']['title'] }}" />
            </div>
            <div class="space-y-5 text-center lg:text-left wow fadeIn">
                <h3 class="text-2xl font-bold text-text-black">{{ $metaData['our-vision']['title'] }}</h3>
                <p class="paragraph">
                    {{ $metaData['our-vision']['description'] }}
                </p>
            </div>
        </div>
