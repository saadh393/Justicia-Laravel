...
<section>
    ...
    <div class="primary-gradient-pink  py-28 relative hero-section">
        ...
        <div class="px-4 md:px-0 max-w-4xl mx-auto  relative">
            ...
            <h1 class="text-slate-50 text-center text-[45px] leading-[60px] font-[600]">{{
                $metaData['our-recent-works']['title'] }}</h1>
            <p class="text-lg tracking-wide text-white text-center mt-4">{{ $metaData['our-recent-works']['description']
                }}</p>
        </div>
    </div>
</section>
...
<section class="py-16 space-y-20">
    <div>
        <ul class='flex gap-2 mx-auto items-center justify-center flex-wrap' id="categoryFilter">
            ...
            <li class="px-4 py-1 bg-gray-200 rounded-full cursor-pointer" data-category="{{ $category->id }}">
