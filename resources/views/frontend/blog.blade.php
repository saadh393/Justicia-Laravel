    ...
    <section>
        ...
        <div class="primary-gradient-pink  py-28 relative hero-section">
            ...
            <div class="px-4 md:px-0 max-w-4xl mx-auto  relative">
                ...
                <h1 class="text-slate-50 text-center text-[45px] leading-[60px] font-[600]">{{ $metaData['our-recent-works']['title'] }}</h1>
                <p class="text-lg tracking-wide text-white text-center mt-4">{{ $metaData['our-recent-works']['description'] }}</p>
            </div>
        </div>
    </section>
