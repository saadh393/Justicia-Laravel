...
<body>
    <!-- Navbar -->
    <nav class="top-8 left-1/2 absolute -translate-x-1/2 z-50 bg-slate-50/20 px-14 py-4 block mx-auto backdrop-blur-xl rounded-full">
      <ul class="flex gap-8">
...
<footer class="lg:h-[600px] grid place-items-center relative">
      <img class="hidden lg:block absolute left-0 bottom-0" src="./assets/footer-left.svg" alt="" />
      <img class="hidden lg:block absolute right-0 bottom-0" src="./assets/footer-right.svg" alt="" />
      <div class="container text-center py-20 pt-32 lg:p-0 lg:mt-32">
        <h1 class="text-4xl text-white">Interested in Working with us?</h1>
        <a class="btn bg-[#FF438A] !inline-block my-10 text-slate-50 !px-14 !rounded-full" href="#">Join us as Volunteer</a>
