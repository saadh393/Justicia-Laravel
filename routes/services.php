...
Route::resource('services/backendpublication','Services\BackendpublicationController');
...
Route::resource('services/workcategoriescontroller','Services\WorkcategoriescontrollerController');
